...
class ChatCompletionAssistantMessageParam(BaseModel):
    ...
    content: "Optional[Union[str, List[ContentArrayOfContentPart], None]]"=Field(default_factory=list)
    ...
    tool_calls: "Optional[List[ChatCompletionMessageToolCallParam]]"=Field(default_factory=list)
