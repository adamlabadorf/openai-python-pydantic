...
class Message(BaseModel):
    content: "ResponseInputMessageContentListParam"= None
    ...
    role: "Literal['user', 'system', 'developer']"= None
...
class ComputerCallOutput(BaseModel):
    ...
    output: "ResponseComputerToolCallOutputScreenshotParam"= None
    
    """A computer screenshot image used with the computer use tool."""

    type: "Literal['computer_call_output']"= None
...
class FunctionCallOutput(BaseModel):
    ...
    type: "Literal['function_call_output']"= None
...
ResponseInputParam = List[ResponseInputItemParam]
