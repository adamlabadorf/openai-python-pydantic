...
class ImageGenerateParams(BaseModel):
    ...
    # old  moderation: Optional[Literal["low", "auto"]]
    ...
    # old  output_compression: Optional[int]
    ...
    # old  output_format: Optional[Literal["png", "jpeg", "webp"]]
    ...
    # old  quality: Optional[Literal["standard", "hd", "low", "medium", "high", "auto"]]
    ...
    size: Optional[ Literal["auto", "1024x1024", "1536x1024", "1024x1536", "256x256", "512x512", "1792x1024", "1024x1792"] ] = None
    # old  size: Optional[ Literal["auto", "1024x1024", "1536x1024", "1024x1536", "256x256", "512x512", "1792x1024", "1024x1792"] ]
    ...
    # old  style: Optional[Literal["vivid", "natural"]]
