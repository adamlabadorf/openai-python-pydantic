...
class WebsocketConnectionOptions(BaseModel):
    ...
    extensions: Optional[Sequence[ClientExtensionFactory] | None] = None
    # old  extensions: Sequence[ClientExtensionFactory] | None
    """List of supported extensions, in order in which they should be negotiated and run."""

    subprotocols: Optional[Sequence[Subprotocol] | None] = None
    # old  subprotocols: Sequence[Subprotocol] | None
    """List of supported subprotocols, in order of decreasing preference."""

    compression: Optional[str | None] = None
    # old  compression: str | None
    ...
    # old  max_size: int | None
    """Maximum size of incoming messages in bytes. None disables the limit."""

    max_queue: Optional[int | None | tuple[int | None, int | None]] = None
    # old  max_queue: int | None | tuple[int | None, int | None]
    ...
    # old  write_limit: int | tuple[int, int | None]
